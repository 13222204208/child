...
var bannerService = service.ServiceGroupApp.WechatServiceGroup.BannerService
...
// @accept application/json
// @Produce application/json
// @Param data body wechat.Banner true "删除Banner"
...
// @accept application/json
// @Produce application/json
// @Param data body wechat.Banner true "更新Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query wechat.Banner true "用id查询Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query wechatReq.BannerSearch true "分页获取Banner列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /banner/getBannerList [get]
func (bannerApi *BannerApi) GetBannerList(c *gin.Context) {
	var pageInfo wechatReq.BannerSearch
...
func (bannerApi *BannerApi) GetList(c *gin.Context) {
	if list, err := bannerService.GetBannerList(); err != nil {
		response.FailWithMessage("获取失败", c)
	} else {
