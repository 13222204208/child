...
var messageService = service.ServiceGroupApp.WechatServiceGroup.MessageService
...
// @Param data body wechat.Message true "创建Message"
...
// @accept application/json
// @Produce application/json
// @Param data body wechat.Message true "删除Message"
...
// @accept application/json
// @Produce application/json
// @Param data body wechat.Message true "更新Message"
...
// @accept application/json
// @Produce application/json
// @Param data query wechat.Message true "用id查询Message"
...
// @accept application/json
// @Produce application/json
// @Param data query wechatReq.MessageSearch true "分页获取Message列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /message/getMessageList [get]
func (messageApi *MessageApi) GetMessageList(c *gin.Context) {
	var pageInfo wechatReq.MessageSearch
...
// Accepts the value of the category to get the contents of message
func (messageApi *MessageApi) GetMessageByCategory(c *gin.Context) {
	var message wechat.Message
	err := c.ShouldBindQuery(&message)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
	...
	if list, err := messageService.GetMessageListByCategory(*message.Category); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
	} else {
		response.OkWithData(gin.H{"info": list}, c)
	}
}
