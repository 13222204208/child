<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="信息内容" prop="cotent" width="320" />
        <el-table-column align="left" label="信息所属" prop="category" width="160">
            <template #default="scope">
            {{ filterDict(scope.row.category,messageTypeOptions) }}
            </template>
        </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="140px">
        <el-form-item label="信息内容:"  prop="cotent" >
          <el-input v-model="formData.cotent" type="textarea"  placeholder="请输入" />
        </el-form-item>
