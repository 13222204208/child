<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="openid" prop="openid" width="260" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        <el-form-item label="openid:"  prop="openid" >
          <el-input v-model="formData.openid" :clearable="false"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="unionid:"  prop="unionid" >
          <el-input v-model="formData.unionid" :clearable="false"  placeholder="请输入" />
        </el-form-item>
        ...
        <el-form-item label="地址:"  prop="address" >
          <el-input v-model="formData.address" :clearable="false"  placeholder="请输入" />
        </el-form-item>
